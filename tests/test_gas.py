...
class TestGasRequirements:
    ...
    def test_arc_always_sufficient(self):
        ...
        has_gas, error = check_gas_requirements(Network.ARC_TESTNET, Decimal("0"), "CCTP transfer")
    ...
    def test_exact_requirement(self):
        ...
        has_gas, error = check_gas_requirements(Network.BASE_SEPOLIA, required, "test")
